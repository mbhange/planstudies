          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <h1 className="text-4xl lg:text-6xl font-bold leading-tight mb-6">
                Study in{" "}
                <span className="text-yellow-300 animate-pulse">Germany</span>
              </h1>
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">
                Unlock your potential with world-class education, multicultural
                experiences, and endless opportunities in Europe's economic
                powerhouse and innovation leader.
              </p>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Discover the exceptional advantages that make Germany a premier
            ...
            {[
              {
                ...
                description:
                  "Many public universities offer programs with no or minimal tuition fees, making quality education accessible.",
                delay: "delay-100",
              },
              {
                icon: "💰",
                ...
                description:
                  "Germany is home to some of the best institutions globally, known for academic rigor and innovation.",
                delay: "delay-200",
              },
              {
                icon: "🌍",
                title: "Cultural and Economic Hub",
                description:
                  "Experience a rich cultural environment and access opportunities in Europe's largest economy.",
                delay: "delay-300",
              },
              {
                icon: "💼",
                ...
                description:
                  "Students can work part-time during studies and enjoy post-study work visas for career building.",
                delay: "delay-400",
              },
              {
                icon: "🔬",
                ...
                description:
                  "Renowned for engineering, technology, and sciences with cutting-edge research facilities.",
                delay: "delay-500",
              },
              {
                icon: "🏠",
                ...
                description:
                  "Choose from a wide range of programs across all disciplines with international recognition.",
                delay: "delay-600",
              },
            ].map((benefit, index) => (
              <div
            ...
            {[
              {
                number: "400+",
                label: "Universities",
                sublabel: "High-quality institutions",
              },
              {
                number: "€0",
                label: "Tuition Fees",
                sublabel: "Many public universities",
              },
              {
                number: "18 Months",
                label: "Post-Study Work",
                sublabel: "Job search visa",
              },
              {
                number: "200+",
                label: "Nationalities",
                sublabel: "International community",
              },
            ].map((stat, index) => (
              <div
                key={index}
        ...
        <div className="relative max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-xl text-gray-300 mb-10 leading-relaxed max-w-3xl mx-auto">
              Join thousands of international students who have chosen Germany as
...
export default GermanyAnimatedLayout;
