          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <h1 className="text-4xl lg:text-6xl font-bold leading-tight mb-6">
                Study in{" "}
                <span className="text-yellow-300 animate-pulse">Singapore</span>
              </h1>
            ...
            >
              <div className="relative">
                <img
                  src="https://upload.wikimedia.org/wikipedia/commons/thumb/4/48/Flag_of_Singapore.svg/1920px-Flag_of_Singapore.svg.png"
                  alt="Singapore Flag"
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Discover the exceptional advantages that make Singapore Asia's premier
              destination for international education and innovation
            </p>
          </div>
        ...
        <div className="relative max-w-4xl mx-auto text-center">
          ...
          >
            <h3 className="text-4xl lg:text-5xl font-bold text-white mb-6">
              Ready to Begin Your Singapore Adventure?
            </h3>
            <p className="text-xl text-gray-300 mb-10 leading-relaxed max-w-3xl mx-auto">
              Join thousands of international students who have chosen Singapore as
              their pathway to success in Asia. Let PlanStudies guide you through every
              step of your educational journey in this dynamic city-state.
            </p>
...
export default SingaporeAnimatedLayout;
