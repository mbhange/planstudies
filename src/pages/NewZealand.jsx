...
const NewZealandAnimatedLayout = () => {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <h1 className="text-4xl lg:text-6xl font-bold leading-tight mb-6">
                Study in{" "}
                <span className="text-yellow-300 animate-pulse">New Zealand</span>
              </h1>
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">
                ...
                most beautiful and innovative countries.
              </p>
            ...
            >
              <div className="relative">
                <img
                  src="https://upload.wikimedia.org/wikipedia/commons/thumb/3/3e/Flag_of_New_Zealand.svg/1920px-Flag_of_New_Zealand.svg.png"
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Discover the exceptional advantages that make New Zealand a premier
            ...
            {[
              {
                ...
                description:
                  "Degrees from New Zealand institutions are respected worldwide with high academic standards.",
                delay: "delay-100",
              },
              {
                icon: "💰",
                ...
                description:
                  "Focus on practical learning and real-world problem-solving with cutting-edge approaches.",
                delay: "delay-200",
              },
              {
                icon: "🌍",
                ...
                description:
                  "Known for its friendly communities and low crime rates, New Zealand is a safe and inclusive destination.",
                delay: "delay-300",
              },
              {
                icon: "💼",
                ...
                description:
                  "Benefit from flexible post-study work visas to build your career in an innovative economy.",
                delay: "delay-400",
              },
              {
                icon: "🏖️",
                ...
                description:
                  "Students can work part-time during their studies to gain experience and support living expenses.",
                delay: "delay-500",
              },
              {
                icon: "🏠",
                title: "Natural Beauty & Innovation",
                description:
                  "Study in stunning natural landscapes while accessing world-class research and innovation facilities.",
                delay: "delay-600",
              },
            ].map((benefit, index) => (
              <div
            ...
            {[
              {
                number: "8",
                label: "Universities",
                sublabel: "All world-ranked",
              },
              {
                number: "#1",
                label: "Quality of Life",
                sublabel: "Global peace index",
              },
              {
                number: "3 Years",
                label: "Post-Study Work",
                sublabel: "Open work visa",
              },
              {
                number: "160+",
                label: "Nationalities",
        ...
        <div className="relative max-w-4xl mx-auto text-center">
          ...
          >
            <h3 className="text-4xl lg:text-5xl font-bold text-white mb-6">
              Ready to Begin Your Kiwi Adventure?
            </h3>
            <p className="text-xl text-gray-300 mb-10 leading-relaxed max-w-3xl mx-auto">
              Join thousands of international students who have chosen New Zealand as
...
export default NewZealandAnimatedLayout;
