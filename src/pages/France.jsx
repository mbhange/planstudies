          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <h1 className="text-4xl lg:text-6xl font-bold leading-tight mb-6">
                Study in{" "}
                <span className="text-yellow-300 animate-pulse">France</span>
              </h1>
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">
                Unlock your potential with world-class education, cultural
                experiences, and endless opportunities in the heart of Europe's
                most elegant country.
              </p>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Discover the exceptional advantages that make France a premier
              destination for international education and cultural immersion
            </p>
          </div>
            ...
            {[
              {
                ...
                description:
                  "France is home to some of the world's best universities and business schools, known for excellence in various fields.",
                delay: "delay-100",
              },
              {
                icon: "💰",
                ...
                description:
                  "Public institutions offer competitive tuition costs, with scholarships available for international students.",
                delay: "delay-200",
              },
              {
                icon: "🌍",
                ...
                description:
                  "Choose from a wide array of programs in English or French, catering to every academic interest.",
                delay: "delay-300",
              },
              {
                icon: "💼",
                ...
                description:
                  "Students can work part-time during studies and benefit from post-study work permits.",
                delay: "delay-400",
              },
              {
                icon: "🏛️",
                ...
                description:
                  "Immerse yourself in France's rich history, art, and gastronomy while studying in a multicultural environment.",
                delay: "delay-500",
              },
              {
                icon: "🚀",
                ...
                description:
                  "Access to cutting-edge research facilities and innovation centers in technology and sciences.",
                delay: "delay-600",
              },
            ].map((benefit, index) => (
              <div
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 text-center">
            {[
              ...
              },
              {
                number: "45+",
                label: "Countries",
                sublabel: "International diversity",
              },
            ].map((stat, index) => (
              <div
                key={index}
        ...
        <div className="relative max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-xl text-gray-300 mb-10 leading-relaxed max-w-3xl mx-auto">
              Join thousands of international students who have chosen France as
              their pathway to success. Let PlanStudies guide you through every
              step of your educational journey in the land of elegance and opportunity.
            </p>
...
export default FranceAnimatedLayout;
